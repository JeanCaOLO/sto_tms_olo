...
- ALWAYS fechar las entradas de `docs/work/` y los aprendizajes con la fecha REAL del día (son inmutables), NUNCA con el `Last Updated` de `aidlc-state.md` ni la fecha de un artefacto previo — anclarse en esa fecha derivada produce entradas con fecha equivocada (learned 2026-09-16)
- Al re-correr una etapa por drift con reuniones nuevas indexadas, consultar PRIMERO `project.md` (`## Decided`) y los documentos por id antes de preguntar: lo firme ya vive ahí y evita re-abrir lo cerrado; el requirements.md previo se trata como base a CORREGIR (learned 2026-09-16)
