...
> negocio). Fecha: 2026-09-21. Complementa, no reemplaza, `CONTEXTO_PROYECTO_TMS.md`,
> `PLAN_MODULO_OMS.md` y las decisiones en `aidlc/spaces/default/memory/project.md`.
...
/planificacion                     Planificación de rutas (motor propio + EFLOW QA)
  └─ route-systems/*               Sistemas de ruteo por cliente (ej. Cofersa)
